      ...
      <div className="mx-auto grid max-w-7xl gap-5">
        <header className="flex flex-col gap-4 rounded-[32px] bg-serenity-surface p-6 shadow-neumorphic md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-serenity-muted">先跑通学生档案、班级、校区过滤和身份证号脱敏展示。</p>
          </div>
          ...
          <div className="grid gap-5">
            ...
            <section className="rounded-[28px] bg-serenity-surface p-5 shadow-neumorphic">
              ...
              <div className="mt-5 overflow-hidden rounded-3xl bg-serenity-bg shadow-insetSoft">
                <div className="grid grid-cols-[1.1fr_0.8fr_0.9fr_1fr_1fr_0.7fr] gap-3 border-b border-white/70 px-5 py-3 text-sm font-semibold text-serenity-muted">
                  <span>姓名</span>
                  <span>年级</span>
                  <span>班级</span>
                  <span>学校</span>
                ...
                {students.map((student) => (
                  <div
                    key={student.id}
                    className="grid grid-cols-[1.1fr_0.8fr_0.9fr_1fr_1fr_0.7fr] gap-3 px-5 py-4 text-sm"
                  >
